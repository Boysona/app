...
def set_bot_info_and_startup():
    ...
    try:
        ...
        bot.set_my_description(
            "🤖 Este bot puede transcribir mensajes de voz, archivos de audio o videos rápida y precisamente de forma gratuita.",
            language_code="es"
        )
        bot.set_my_short_description(
            "🎤 Transcribe tu audio y video en segundos totalmente gratis\n\n¿Ayuda? Contacto: @boyso20",
            language_code="es"
        )
        bot.set_my_description(
            "🤖 Ushbu bot ovozli xabarlar, audio fayllar yoki videolarni tez va aniq transkribe qila oladi — bepul.",
            language_code="uz"
        )
        bot.set_my_short_description(
            "🎤 Ovoz va videongizni soniyalar ichida transkribe qiling, butunlay bepul\n\nYordam: @boyso20",
            language_code="uz"
        )
        bot.set_my_description(
            "🤖 این ربات می‌تواند پیام‌های صوتی، فایل‌های صوتی یا ویدیوها را به سرعت و با دقت رونویسی کند — رایگان.",
            language_code="fa"
        )
        bot.set_my_short_description(
            "🎤 صوت و ویدیوهای خود را در عرض چند ثانیه رایگان رونویسی کنید.\nکمک: @boyso20",
            language_code="fa"
        )
